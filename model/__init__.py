...
try:
    ...
    _import_structure["action_tokenizer"] = ["SphericalCoordinateActionTokenizer", "ActionTokenizer"]
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .action_tokenizer import SphericalCoordinateActionTokenizer, ActionTokenizer
